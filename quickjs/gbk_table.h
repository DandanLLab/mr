...
/// GBK→Unicode 映射条目数
#define GBK_TABLE_SIZE 21791

/// GBK→Unicode 映射对 (gbk_code, unicode)
/// 按 gbk_code 升序排列
static const uint16_t gbk_to_unicode_table[21791][2] = {
    {0x8140, 0x4E02},
    {0x8141, 0x4E04},
    {0x8142, 0x4E05},
    {0x8143, 0x4E06},
...
/// Unicode→GBK 映射对 (unicode, gbk_code)
/// 按 unicode 升序排列
static const uint16_t unicode_to_gbk_table[21791][2] = {
    {0x00A4, 0xA1E8},
    {0x00A7, 0xA1EC},
    {0x00A8, 0xA1A7},
    {0x00B0, 0xA1E3},
